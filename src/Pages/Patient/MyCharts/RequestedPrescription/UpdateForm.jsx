...
function UpdateForm() {
  ...
  const inputMoreDetail = [
    ...
    {
      placeholder: 'I want to be sure of my health conditions.',
    ...
    {
      placeholder: 'W: 170 lbs / 77.1 Kg, H: 63 in. / BMI: 30.1',
      label: 'Vital Signs',
    },
    {
    ...
    { placeholder: 'NO', label: ' Breastfeeding?' },
    {
      placeholder: 'No',
      label:
        ' Has the patient ever had an allergic reaction to Munjaro, tripeptide or another GLP-1 receptor against diabetes medication ?',
    },
    {
      placeholder: 'NO',
      label:
    ...
    },
    {
      placeholder: 'NO',
      label:
        ' Has the patient or a family member been diagnosed with multiple Endocrine Neoplasia syndrome?',
    },
    {
      placeholder: 'NO',
      label:
        ' Has the patient been diagnosed with gallbladder,pancreas, heart, or kidney problems?',
    },
    {
      placeholder: 'NO',
    ...
    },
    {
      placeholder: 'NO',
      label:
        ' Is the patient pregnant, or planning to get pregnant in the near future, or breastfeeding?',
    },
  ];

  const PharmacyDetail = [
    {
      placeholder: '135 Barclay Cir, Ste 103Rochester Hills, MI 48307',
      label: 'Address',
      type: 'text',
    },
          ...
          <Col>
            ...
            >
              <h6 className='  pb-4 border-bottom mx-4'>
                <b style={{ color: '#FAB915', width: '90%' }}>Provided Data</b>
              </h6>
