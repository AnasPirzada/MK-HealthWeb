        ...
        <Row className='pb-5'>
          ...
          >
            <div className='text-center w-75 shadow py-4  my-4 my-md-0'>
              ...
              <p style={{ fontSize: '12px' }} className='w-75 m-auto '>
                Place your request online and pay the all-inclusive fees for the
                lab tests.
              </p>
            </div>
          ...
          >
            <div className='text-center w-75 shadow py-4 my-4 my-md-0'>
              ...
              <p style={{ fontSize: '12px' }} className='w-75 m-auto '>
                A licensed medical provider in your state will review your
                request and authorize a lab order.
              </p>
            </div>
            <div className='text-center w-25 mobile-none'>
              <img src='/Arrow - Right.svg' alt='' />
          ...
          <Row className='mt-5'>
            <div className=' text-center'>
              <Link to='/LabRequest'>
                <button
                  className='w-25 border-0 p-2 rounded-5 text-white '
                  style={{ backgroundColor: '#FAB915' }}
                >
                  Next
                  <img className='ms-3' src='./Component 622 – 1.svg' />
                </button>
              </Link>
            </div>
          </Row>
