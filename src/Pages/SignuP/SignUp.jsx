        ...
        <div className='bg-form' style={{ height: '' }}>
          <Container style={{ height: '100vh' }}>
            <Row>
              <Col
                md={6}
                className='d-flex align-items-center justify-content-center flex-column mobile80vh'
                style={{ height: '95vh' }}
              >
                <h3 className='mt-3'>
                  <b>Sign Up</b>
                ...
                {inputFields.map((field, index) => (
                  <div
                    key={index}
                    className={`input-container shadow bg-light mt-4 ${
                      validationErrors[field.name] ? 'border border-danger' : ''
                    } ${
                      buttonClicked && formData[field.name] === '' ? '' : ''
                    }`}
                  >
                ...
                <p className='mt-3'>
                  ...
                  <Link to='/Login'>
                    {' '}
                    <span style={{ color: '#FAB915' }}>Sign in</span>{' '}
                  </Link>
                </p>
              </Col>
              <Col
